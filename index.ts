...
class AdventureGame{
    static async main():Promise<void>{
        let randNumber:number = Math.floor(Math.random()*100);
        let ourEnemies:string[] = ["Skeleton", "Zombie", "Warrior","Assassin"];
        // Game Variable
        ...
        let healthPotionDropAmount:number = 50;  //enemy drop potion
...
let ourAdventureGame:AdventureGame = new AdventureGame();
AdventureGame.main();